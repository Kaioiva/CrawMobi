...
class zoom:
	...
	def preçoZoom(self):
		...
		try:
			...
			pesquisa = driver.find_element_by_xpath('//*[@id="search-field"]')
			...
			try:
				...
				preço = driver.find_element_by_xpath('//*[@id="mobile-container"]/div[1]/section/header/div/div[2]/div[2]/div[2]/div/div[2]/p/span[2]/a/strong').text
